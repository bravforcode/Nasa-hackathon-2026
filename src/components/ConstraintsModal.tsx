      ...
      <div className="space-y-4 text-xs text-slate-200 font-mono">
        ...
        <div className="space-y-1 bg-black/40 p-3.5 rounded-xl border border-white/10">
          <div className="flex justify-between">
            <span className="text-blue-300 font-bold">Rule-14.2 Minimum Battery Reserve</span>
          ...
          <input
            ...
            className="w-full accent-blue-400 h-1.5 bg-slate-800 rounded-lg cursor-pointer mt-1"
          />
        </div>
        ...
        <div className="space-y-1 bg-black/40 p-3.5 rounded-xl border border-white/10">
          <div className="flex justify-between">
            <span className="text-blue-300 font-bold">Maximum Allowed Comms Outage</span>
        ...
        <div className="space-y-1 bg-black/40 p-3.5 rounded-xl border border-white/10">
          <div className="flex justify-between">
            <span className="text-blue-300 font-bold">Slope Traversability Cap</span>
