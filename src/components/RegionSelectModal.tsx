        ...
        {LUNAR_REGIONS.map((region) => {
          ...
          return (
            <button
              ...
              className={`p-4 rounded-xl border text-left flex flex-col justify-between transition-all cursor-pointer backdrop-blur-xl outline-none focus-visible:ring-2 focus-visible:ring-blue-400 ${
                isSelected
            ...
            >
              ...
              <div className="mt-3 pt-2 border-t border-white/10 flex justify-between items-center text-[10px] font-mono text-blue-300">
