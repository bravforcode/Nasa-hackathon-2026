...
export const TelemetryCards: React.FC<TelemetryCardsProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      {/* 3 Golden KPI Header Strip — Luxury Double-Bezel Aerospace Analytics */}
      <section
      ...
      >
        ...
        <article
          className={`group ring-1 transition-all duration-300 rounded-2xl p-1 shadow-xl relative overflow-hidden ${
            isCommCritical
              ? 'ring-red-500/30 bg-red-500/[0.04] shadow-red-500/10'
              : 'ring-white/10 bg-white/[0.02] hover:ring-blue-400/30 shadow-black/40'
          }`}
          ...
          <div className="p-3.5 bg-gradient-to-b from-slate-900/90 to-slate-950/95 rounded-xl border border-white/[0.06] flex flex-col justify-between h-full shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)]">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className={`p-1.5 rounded-lg border ${
                  ...
                  {isCommCritical ? (
                    <WifiOff className="w-3.5 h-3.5 animate-pulse" aria-hidden="true" />
                  ) : (
              ...
              <StatusPill
                ...
                isLive={true}
                className="py-0.5 px-2 text-3xs rounded-full"
              >
            ...
            <div className="flex items-baseline justify-between gap-2 my-2">
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="font-mono text-3xs text-slate-400 uppercase">Area QoS</span>
              </div>
              ...
              >
                <div
                  className={`h-full rounded-full transition-all duration-500 ${
                    isCommCritical
                      ? 'bg-gradient-to-r from-red-600 to-rose-400 shadow-[0_0_10px_rgba(239,68,68,0.6)]'
                      : 'bg-gradient-to-r from-blue-600 to-cyan-400 shadow-[0_0_10px_rgba(59,130,246,0.6)]'
                  }`}
                  style={{ width: `${Math.min(100, Math.max(0, coveragePercent))}%` }}
                />
                {/* 80% Critical Floor Tick */}
                <div
                  className="absolute top-0 bottom-0 w-0.5 bg-white/70 z-10 shadow-[0_0_4px_white]"
                  style={{ left: '80%' }}
        ...
        <article
          className={`group ring-1 transition-all duration-300 rounded-2xl p-1 shadow-xl relative overflow-hidden ${
            isBatteryLow
              ...
              : 'ring-white/10 bg-white/[0.02] hover:ring-emerald-400/30 shadow-black/40'
          }`}
          ...
          <div className="p-3.5 bg-gradient-to-b from-slate-900/90 to-slate-950/95 rounded-xl border border-white/[0.06] flex flex-col justify-between h-full shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)]">
              ...
              <div className="flex items-center gap-2">
                <div className={`p-1.5 rounded-lg border ${
                  ...
                  {isBatteryLow ? (
                    ...
                    <BatteryCharging className="w-3.5 h-3.5" aria-hidden="true" />
                  ) : (
                    <BatteryCharging className="w-3.5 h-3.5" aria-hidden="true" />
                  )}
                </div>
            ...
            <div className="flex items-baseline justify-between gap-2 my-2">
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="font-mono text-3xs text-slate-400 uppercase">Reserve SoC</span>
              </div>
                ...
                <div
                  className={`h-full rounded-full transition-all duration-500 ${
                    isBatteryLow
                      ? 'bg-gradient-to-r from-red-600 to-rose-400 shadow-[0_0_10px_rgba(239,68,68,0.6)]'
                      : isBatteryCaution
                      ? 'bg-gradient-to-r from-amber-600 to-yellow-400 shadow-[0_0_10px_rgba(245,158,11,0.6)]'
                      : 'bg-gradient-to-r from-emerald-600 to-teal-400 shadow-[0_0_10px_rgba(16,185,129,0.6)]'
                  }`}
        ...
        <article
          className={`group ring-1 transition-all duration-300 rounded-2xl p-1 shadow-xl relative overflow-hidden ${
            isReplanning
              ? 'ring-amber-500/30 bg-amber-500/[0.04] shadow-amber-500/10'
              : 'ring-white/10 bg-white/[0.02] hover:ring-emerald-400/30 shadow-black/40'
          }`}
        ...
        >
          <div className="p-3.5 bg-gradient-to-b from-slate-900/90 to-slate-950/95 rounded-xl border border-white/[0.06] flex flex-col justify-between h-full shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)]">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className={`p-1.5 rounded-lg border ${
                  ...
                  <Route
                    className={`w-3.5 h-3.5 ${isReplanning ? 'animate-pulse' : ''}`}
                    aria-hidden="true"
                  />
                </div>
                <span className="font-mono text-3xs text-slate-300 uppercase font-bold tracking-wider">
            ...
            <div className="flex items-baseline justify-between gap-2 my-2">
              <div className="flex items-baseline gap-1.5">
                <span
                  className={`font-headline text-2xl font-extrabold uppercase tracking-tight ${
            ...
            <div className="space-y-1.5">
              ...
              >
                <div className={`h-full rounded-l-full flex-1 transition-all duration-500 ${isReplanning ? 'bg-amber-500' : 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]'}`} />
                <div className={`h-full flex-1 transition-all duration-500 ${isReplanning ? 'bg-amber-500/80' : 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]'}`} />
                <div className={`h-full flex-1 transition-all duration-500 ${isReplanning ? 'bg-amber-500/50' : 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]'}`} />
                <div className={`h-full rounded-r-full flex-1 transition-all duration-500 ${isReplanning ? 'bg-slate-700/60 animate-pulse' : 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]'}`} />
              </div>
      ...
      <div className="flex justify-center -mt-0.5">
        <Button
          ...
          className="text-3xs font-mono uppercase tracking-widest px-4 !py-1 !min-h-[28px] rounded-full shadow-md bg-slate-900/60 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all duration-150"
        >
          {isDrawerOpen ? 'Hide Diagnostics' : 'Constellation Diagnostics & Space Weather'}
        </Button>
      </div>

      {/* Expandable Diagnostics Drawer — Luxury Drilldown Dashboard */}
      {isDrawerOpen && (
        <Card
          ...
          variant="default"
          padding="md"
          className="backdrop-blur-2xl shadow-2xl animate-in slide-in-from-top-2 duration-200 border border-white/10 bg-slate-950/80"
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {/* Column 1: Current Relay Links (Constellation) */}
            <section className="flex flex-col gap-2" aria-label="Relay Constellation Status">
              <header className="font-mono text-3xs text-slate-300 uppercase tracking-wider font-bold border-b border-white/[0.08] pb-1.5 flex items-center justify-between">
                ...
                {relays.map((r) => {
                  ...
                  return (
                    <div
                      key={r.id}
                      role="listitem"
                      className={`flex justify-between items-center text-xs p-2 rounded-xl border backdrop-blur-md transition-all duration-150 ${
                        isOffline
                    ...
                    >
                      ...
                      <StatusPill tone={tone} className="py-0.5 px-2 text-3xs rounded-full">
                        {label}
                      </StatusPill>
                    </div>
                  );
            ...
            <section className="flex flex-col gap-2" aria-label="Space Weather DONKI Status">
              <header className="font-mono text-3xs text-slate-300 uppercase tracking-wider font-bold border-b border-white/[0.08] pb-1.5 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  <Thermometer className="w-3.5 h-3.5 text-amber-400 shrink-0" aria-hidden="true" />
                  <span>Space Weather [DONKI]</span>
                </div>
                <StatusPill tone="warning" className="py-0.5 px-2 text-3xs rounded-full">
                  MODERATE
                </StatusPill>
              </header>

              <div className="p-3 bg-white/[0.03] rounded-xl border border-white/[0.06] flex flex-col gap-2">
                <div className="flex justify-between items-center">
                ...
                >
                  <div className="flex gap-1.5 h-10 items-end">
                    <div className="flex-1 bg-slate-800 rounded-t-sm h-[25%]" title="T-06h: Baseline" />
                    <div className="flex-1 bg-slate-800 rounded-t-sm h-[40%]" title="T-04h: Minor Fluctuation" />
                    <div className="flex-1 bg-slate-800 rounded-t-sm h-[35%]" title="T-02h: Nominal" />
                    <div className="flex-1 bg-amber-500 rounded-t-sm h-[75%] shadow-[0_0_10px_rgba(245,158,11,0.5)]" title="NOW: Rising Solar Flux" />
                    <div className="flex-1 bg-amber-500 rounded-t-sm h-[90%] shadow-[0_0_10px_rgba(245,158,11,0.5)]" title="+02h: Peak Flux Forecast" />
                    <div className="flex-1 bg-slate-800 rounded-t-sm h-[30%]" title="+04h: Recovery Expected" />
                  </div>
            ...
            <section className="flex flex-col gap-2" aria-label="Excursion Flight Telemetry">
              <header className="font-mono text-3xs text-slate-300 uppercase tracking-wider font-bold border-b border-white/[0.08] pb-1.5 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
              ...
              <div className="flex justify-end pt-1">
                <Button
                  ...
                  className="w-full rounded-full bg-blue-500/10 hover:bg-blue-500/20 border-blue-500/30 text-blue-300 font-mono text-3xs font-bold !min-h-[32px]"
                >
